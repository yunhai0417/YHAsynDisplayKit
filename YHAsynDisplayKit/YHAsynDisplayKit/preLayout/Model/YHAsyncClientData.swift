...
@objc public protocol YHAsyncClientDataProtocol: NSObjectProtocol {
    // 网络返回的业务数据对应的排版数据
    var cellData:YHAsyncBaseCellData? { get set }
    
    /**
    * 该方法由业务模型数据来实现
    * 一般情况下，该方法由AsyncBusinessModel来实现，实现方式如下：
